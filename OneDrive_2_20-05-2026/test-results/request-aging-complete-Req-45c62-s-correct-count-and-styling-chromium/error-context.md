...
- Name: request-aging-complete.spec.ts >> Request Aging Visualization - Complete Suite >> Bucket Cards >> Fresh bucket displays correct count and styling
- Location: tests/e2e/request-aging-complete.spec.ts:77:5
...
Locator: locator('text=Fresh').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Fresh').first()
...
- generic [ref=e1]:
            ...
            - generic [ref=e8]:
              ...
              - generic [ref=e23]:
                - generic [ref=e24]:
                  ...
                  - generic [ref=e29]:
                    - generic [ref=e30]: "Request Id: bd490924-ab5b-48d4-8a8f-a5d3726b4300"
                    - generic [ref=e31]: "Correlation Id: 019ecfc0-7e74-777c-aa65-35fc6df62bd5"
                    - generic [ref=e32]: "Timestamp: 2026-06-16T09:26:00Z"
  ...
  - textbox [ref=e44]: "Request Id: bd490924-ab5b-48d4-8a8f-a5d3726b4300 Correlation Id: 019ecfc0-7e74-777c-aa65-35fc6df62bd5 Timestamp: 2026-06-16T09:26:00Z Message: AADSTS900023: Specified tenant identifier 'dev-tenant-id' is neither a valid DNS name, nor a valid external domain."
```
