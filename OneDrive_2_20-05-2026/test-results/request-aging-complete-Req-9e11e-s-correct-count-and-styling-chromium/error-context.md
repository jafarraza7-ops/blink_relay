...
- Name: request-aging-complete.spec.ts >> Request Aging Visualization - Complete Suite >> Bucket Cards >> Stale bucket displays correct count and styling
- Location: tests/e2e/request-aging-complete.spec.ts:101:5
...
Locator: locator('text=Stale').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Stale').first()
...
- generic [ref=e1]:
            ...
            - generic [ref=e8]:
              ...
              - generic [ref=e23]:
                - generic [ref=e24]:
                  ...
                  - generic [ref=e29]:
                    - generic [ref=e30]: "Request Id: 48da1d80-765e-42b0-bd32-96119a874900"
                    - generic [ref=e31]: "Correlation Id: 019ecfc0-97d0-7d87-a2ff-28ecf0f95f15"
                    - generic [ref=e32]: "Timestamp: 2026-06-16T09:26:06Z"
  ...
  - textbox [ref=e44]: "Request Id: 48da1d80-765e-42b0-bd32-96119a874900 Correlation Id: 019ecfc0-97d0-7d87-a2ff-28ecf0f95f15 Timestamp: 2026-06-16T09:26:06Z Message: AADSTS900023: Specified tenant identifier 'dev-tenant-id' is neither a valid DNS name, nor a valid external domain."
```
