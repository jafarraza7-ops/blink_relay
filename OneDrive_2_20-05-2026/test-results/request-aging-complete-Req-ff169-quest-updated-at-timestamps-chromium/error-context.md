...
- Name: request-aging-complete.spec.ts >> Request Aging Visualization - Complete Suite >> Data Accuracy >> counts are accurate based on request updated_at timestamps
- Location: tests/e2e/request-aging-complete.spec.ts:254:5
...
Locator: locator('text=Fresh').locator('..').locator('text=/\\d+/').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Fresh').locator('..').locator('text=/\\d+/').first()
...
- generic [ref=e1]:
            ...
            - generic [ref=e8]:
              ...
              - generic [ref=e23]:
                - generic [ref=e24]:
                  ...
                  - generic [ref=e29]:
                    - generic [ref=e30]: "Request Id: 6b3c636c-7839-4992-91f9-38a150591500"
                    - generic [ref=e31]: "Correlation Id: 019ecfc0-f544-7041-91df-8de22502d26c"
                    - generic [ref=e32]: "Timestamp: 2026-06-16T09:26:30Z"
  ...
  - textbox [ref=e44]: "Request Id: 6b3c636c-7839-4992-91f9-38a150591500 Correlation Id: 019ecfc0-f544-7041-91df-8de22502d26c Timestamp: 2026-06-16T09:26:30Z Message: AADSTS900023: Specified tenant identifier 'dev-tenant-id' is neither a valid DNS name, nor a valid external domain."
```
