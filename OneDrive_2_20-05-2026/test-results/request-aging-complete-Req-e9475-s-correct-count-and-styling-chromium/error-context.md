...
- Name: request-aging-complete.spec.ts >> Request Aging Visualization - Complete Suite >> Bucket Cards >> Aging bucket displays correct count and styling
- Location: tests/e2e/request-aging-complete.spec.ts:90:5
...
Locator: locator('text=Aging').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Aging').first()
...
- generic [ref=e1]:
            ...
            - generic [ref=e8]:
              ...
              - generic [ref=e23]:
                - generic [ref=e24]:
                  ...
                  - generic [ref=e29]:
                    - generic [ref=e30]: "Request Id: 870ae571-14f9-4b27-bdd8-197724730500"
                    - generic [ref=e31]: "Correlation Id: 019ecfc0-7edd-7105-b759-1f4e35a5fdd3"
  ...
  - textbox [ref=e44]: "Request Id: 870ae571-14f9-4b27-bdd8-197724730500 Correlation Id: 019ecfc0-7edd-7105-b759-1f4e35a5fdd3 Timestamp: 2026-06-16T09:26:00Z Message: AADSTS900023: Specified tenant identifier 'dev-tenant-id' is neither a valid DNS name, nor a valid external domain."
```
